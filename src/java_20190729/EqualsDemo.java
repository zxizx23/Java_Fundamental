...
public class EqualsDemo {
	public static void main(String[] args) {
		...
		int hachCodes1 = s1.hashCode();
		int hachCodes2 = s2.hashCode();
		System.out.println(hachCodes1);
		System.out.println(hachCodes2);
		...
		//hashCode란 객체가 가지는 유일한 값, 반드시 유일한 값을 가져야 함
		...
		//c3.equals(c4) 결과가 true면   c3, c4의 hashCode값은 같고 
		//c3.equals(c4) 결과가 false면 c3, c4의 hashCode값은 달라야한다 
		int hashCode3 = c3.hashCode();
		int hashCode4 = c4.hashCode();
		
		System.out.println(hashCode3);
		System.out.println(hashCode4);
		//c3뒤에 .toString이 생략되어 있음 => c3.toString
